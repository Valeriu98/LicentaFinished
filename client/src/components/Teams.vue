                ...
                <v-container>
                  ...
                  <v-row>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field readonly v-model="editedTeam.Team_name" label="Team name"></v-text-field>

                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field readonly v-model="editedTeam.Couch" label="Couch"></v-text-field>
                    </v-col>

                    <v-col cols="12" sm="6" md="4">
                      <v-text-field readonly v-model="editedTeam.City" label="City"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field readonly v-model="editedTeam.Arena" label="Arena"></v-text-field>
                    </v-col>
...
export default {
  ...
  computed: {
    formTitle () {
      return this.editedIndex === -1 ? 'New Team' : 'View Team'
    }
  },
  watch: {
    dialog (val) {
